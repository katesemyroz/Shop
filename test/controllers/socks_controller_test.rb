...
class SocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sock" do
    assert_difference('Sock.count') do
      post socks_url, params: { sock: { color: @sock.color, damages: @sock.damages, description: @sock.description, name: @sock.name, price: @sock.price, size: @sock.size } }
    end
  ...
  test "should update sock" do
    patch sock_url(@sock), params: { sock: { color: @sock.color, damages: @sock.damages, description: @sock.description, name: @sock.name, price: @sock.price, size: @sock.size } }
